...
function Main(props) {
  ...
  return (
    <div className=" h-full w-full flex-col text-white">
      ...
      <div
        id="carousel"
        className="py-4 mx-2 gap-3 pl-0 h-36 overflow-x-scroll max-w-screen flex justify-between text-white scroll-smooth"
      >
        {/* Categories */}
        <BiLeftArrow
      ...
      <div id="search" ref={searchRef}>
        <form className="flex flex-col p-4 md:p-8 w-full sm:w-[60vw] lg:w-[40vw] xl:w-[35vw]">
          ...
          <span className="text-2xl py-1 w-full text-yellow-200">
            {" "}
            {category}
          </span>
          <input
            ...
            className="mt-2 text-xl p-3 py-1 rounded text-black"
          ></input>
        </form>
      </div>
