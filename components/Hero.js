...
function Hero() {
  ...
  return (
    <div className='relative flex items-center justify-end mt-20 2xl:mt-0 h-[30vh] sm:h-[45vh] md:h-full w-auto bg-gradient-to-b from-white to-black text-slate-300 border-b-2' >
